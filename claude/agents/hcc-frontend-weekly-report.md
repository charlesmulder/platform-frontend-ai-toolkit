...
- **Incidents & Support**: Customer escalations, incidents, support exceptions, or critical support updates
...
Present the report in clean markdown format with:
- Clear section headers
- Bullet points for each item
- JIRA issue references in format `[KEY](URL)` for easy navigation
- Summary statistics at the top (e.g., total issues closed, breakdown by type)
